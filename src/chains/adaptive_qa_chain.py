...
Answer:"""
        self.qa_with_context_prompt = ChatPromptTemplate.from_template(qa_with_context_template)
...
Be as simple and concise as possible — prefer short direct answers over full explanations.
Answer:"""
        self.qa_no_context_prompt = ChatPromptTemplate.from_template(qa_no_context_template)
    ...
    def _setup_graph(self):
        ...
        def route_question(state: QAState) -> Dict:
            ...
            # Prepare the prompt
            prompt = self.router_prompt.invoke({
        ...
        def generate_answer_no_context(state: QAState) -> Dict:
            ...
            prompt = self.qa_no_context_prompt.invoke({
                "question": state["question"]
            })
        ...
        def route_by_question_type(state: QAState) -> Literal["standard_retrieval", "hybrid_retrieval", "no_retrieval"]:
        ...
        graph.add_node("no_retrieval", lambda x: {"context": "No context provided - using model knowledge"})
    ...
    def invoke(self, input_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "used_context": result["context"] != "No context provided - using model knowledge"
        }
